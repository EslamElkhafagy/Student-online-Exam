...
import layout.CreateAssigmaent.CreateAssigmaent;
import layout.Register.Connection;
import layout.course.course;
...
public class doctorprofile extends AppCompatActivity {
    ...
    public void loadData() {
        ...
        Cursor res = db.getProfileData(email, pass);
        if (res.getCount() == 0) {
    ...
    i.putExtra("userid", idtxt.getText().toString());
    startActivity(i);

}

    public void Quizes(View v){

        Intent i = new Intent(this,CreateAssigmaent.class);
        startActivity(i);
